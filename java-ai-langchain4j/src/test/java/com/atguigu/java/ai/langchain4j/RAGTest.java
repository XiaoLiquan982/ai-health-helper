...
//        Document document = FileSystemDocumentLoader.loadDocument("D:/bs/knowledge/测试.txt");
//        System.out.println(document.text());
//        // 加载单个文档
//        Document document = FileSystemDocumentLoader.loadDocument("D:/bs/knowledge/file.txt", new TextDocumentParser());
//// 从一个目录中加载所有文档
//        List<Document> documents = FileSystemDocumentLoader.loadDocuments("D:/bs/knowledge", new TextDocumentParser());
// 从一个目录中加载所有的.txt文档
//        PathMatcher pathMatcher = FileSystems.getDefault().getPathMatcher("glob:*.txt");
        PathMatcher pathMatcher = FileSystems.getDefault().getPathMatcher("glob:*.md");
        List<Document> documents = FileSystemDocumentLoader.loadDocuments("D:/bs/knowledge",pathMatcher, new TextDocumentParser());
...
// 从一个目录及其子目录中加载所有文档
//        List<Document> documents = FileSystemDocumentLoader.loadDocumentsRecursively("D:/bs/knowledge", new TextDocumentParser());
    }
    ...
    public void testReadDocumentAndStore() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument("D:/bs/knowledge/人工智能.md");
