...
//输出大语言模型的回复
    ...
    public void testChatMemory3() {
        ...
        String anwser1 = assistant.chat("我是环环");
        System.out.println(anwser1);
        String anwser2 = assistant.chat("我是谁");
    ...
    public void testChatMemory4() {
        ...
        String anwser1 = memoryChatAssistant.chat("我是张三");
        System.out.println(anwser1);
        String anwser2 = memoryChatAssistant.chat("我是谁");
        System.out.println(anwser2);
    }
    ...
    public void testChatMemory5() {
        ...
        String anwser1 = separateChatAssistant.chat(1,"我是张三");
        System.out.println(anwser1);
        String anwser2 = separateChatAssistant.chat(1,"我是谁");
        System.out.println(anwser2);

        String anwser3 = separateChatAssistant.chat(2,"我是谁");
